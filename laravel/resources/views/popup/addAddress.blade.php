<form class="row g-3" action="{{route('addAddress')}}" method="POST">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @csrf
                    ...
                    <!--</fieldset>-->  
                    <div class="col-8">
                        <label for="addressLine1" class="form-label">addressLine1:</label><span style="color: red !important; display: inline; float: none;">*</span>  
                        <input type="text" class="form-control" name="addressLine1" required>
                    </div>
                    <div class="col-md-8">
                        <label for="addressLine2" class="form-label">addressLine2:</label><span style="color: red !important; display: inline; float: none;">*</span>  
