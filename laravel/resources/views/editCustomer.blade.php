...
<html lang="en">
    ...
    <body>
        <h1 style="text-align: center; text-transform: uppercase; color: #581845;"> Edit Customer </h1>
        ...
        <div class="col-md-8">
            <div class="card">
                <!-- Start HERE -->
                <!-- Form-->
        <form action="{{ url('/customers/update/'.$customers[0]->customerNumber)}}"  method="POST">    
            <div class="content">
            {{ method_field('patch') }} 
            {{ csrf_field() }}
                <div class="modal-body" id="detail">
                    <fieldset disabled>
                        <div class="input-group input-group-sm mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="customerID" value="{{$customers[0]->customerNumber}}" required>
                        </div>
                    </fieldset>
                    <div class="input-group input-group-sm mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-sm">CustomerName</span>
                        <input  name="CustomerName" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="customerName" value="{{$customers[0]->customerName}}" required>
                    </div>
                    <div class="input-group-sm mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="">Contact Person</span>
                        </div>
                        <input  name="firstName" type="text" class="form-control" id="fname" value="{{$customers[0]->contactFirstName}}"required>
                        <input name="lastName" type="text" class="form-control" id="lname" value="{{$customers[0]->contactLastName}}"required>
                    </div>
                    <div class="input-group input-group-sm mb-3">
                    ...
                    <div class="input-group-sm mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="">City/State/Postal Code</span>
                        </div>
                        <input name="City"  type="text" class="form-control" id="ct"  value="{{$customers[0]->city}}" placeholder="City" required>
